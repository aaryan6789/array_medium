/* english_int.c * Created on: Feb 23, 2018 * Author: hsahu */
...
void convert_to_words(char *num) {
    ...
    /* The first string is used, it is to make array indexing simple */
    ...
    /* The 1st two string are not used, they are to make array indexing simple*/
    ...
    if (len == 1) {
     ...
     while (*num != '\0') {
        ...
        /* Code path for last 2 digits */
             ...
             * Sum of the two digits is used as index of "two_digits" array of strings */
            if (*num == '1') {
